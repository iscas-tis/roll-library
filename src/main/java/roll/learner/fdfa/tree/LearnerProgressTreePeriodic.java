...
public class LearnerProgressTreePeriodic extends LearnerProgressTree implements LearnerProgressPeriodic {

    public LearnerProgressTreePeriodic(Options options, Alphabet alphabet,
    ...
    public LearnerType getLearnerType() {
        return LearnerType.FDFA_PERIODIC_TREE;
    }
