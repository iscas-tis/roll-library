...
public class LearnerProgressTableSyntactic extends LearnerProgressTable implements LearnerProgressSyntactic {

    public LearnerProgressTableSyntactic(Options options, Alphabet alphabet,
