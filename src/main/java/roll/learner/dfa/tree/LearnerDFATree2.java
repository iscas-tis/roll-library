...
// only apply to DFA
public abstract class LearnerDFATree2 extends LearnerDFA2{
	...
	public LearnerDFATree2(Options options, Alphabet alphabet,
	...
	protected class CeAnalyzerTree extends CeAnalyzer {
        ...
        protected void update(CeAnalysisResult result) {
            ...
            Word wordPrev = getLabelWord(result.prevState);         // S(j-1)
