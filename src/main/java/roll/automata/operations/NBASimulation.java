...
public class NBASimulation {
    ...
    public static boolean getForwardSimulationRelation(NBA fst, NBA snd) {
        assert fst != snd;
        ...
        return isIncludedViaFSim(fst, snd, fsim, states);
    }
    
    public static boolean isIncludedViaFSim(NBA fst, NBA snd, boolean[][] fsim, StateContainer[] states) {
