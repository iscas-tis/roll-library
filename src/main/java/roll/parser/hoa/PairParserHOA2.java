 ...
 * 
 * */
public class PairParserHOA2 extends ParserHOA2 implements PairParser {
    protected NBA A;
    protected NBA B;
    BDDPairing apB2A = null;
    
    public PairParserHOA2(Options options, String fileA, String fileB) {
        super(options);
        try {
    ...
    public PairParserHOA2(Options options, InputStream fileA, InputStream fileB) {
        super(options);
        try {
