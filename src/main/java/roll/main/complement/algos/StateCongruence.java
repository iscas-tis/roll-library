...
public class StateCongruence extends StateNFA {
	...
	public ISet getSuccessors(int letter) {
		...
		if(congrClass.isSet && congrClass.guess.isEmpty()) {
			...
			if(complement.debug) System.out.println(this.getId() + ": " + this + " -> " + this.getId() + " : " + this + " > " + letter );
		...
		if(congrClass.isSet) {
			...
			CongruenceClass nextCongrCls = new CongruenceClass(nextGuess, complement.fsim, complement.bsim);
			// add one state
			...
			CongruenceClass nextCongrCls = new CongruenceClass(nextLevel, complement.fsim, complement.bsim);
			// add one state
			StateCongruence nextState = complement.getOrAddState(nextCongrCls);
			super.addTransition(letter, nextState.getId());
			if(complement.debug) System.out.println(this.getId() + ": " + this + " -> " + nextState.getId() + " : " + nextState + " > " + letter);
