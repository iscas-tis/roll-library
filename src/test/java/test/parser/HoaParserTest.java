...
import roll.parser.hoa.HOAPairParser;
...
public class HoaParserTest {
    ...
    public void testHOAParser() {
        ...
        HOAParser parser = new HOAParser(options, dir + "A.hoa");
...
//        parser2.parse();
        HOAPairParser pairParser = new HOAPairParser(options, dir + "A.hoa", dir + "B.hoa");
